<template>
	...
	>
		...
		<!-- scale left -->
		<div
				class="chart-tex-y-left"
				:style="{width:current_w + 'px', height:current_h-20 + 'px'}"
		>
			<div
					v-for="(y_scale_item) in y_scale"
					:key="y_scale_item">
				{{y_scale_item}}
			</div>
		</div>
